...
php ${CLASSMAP_GENERATOR} --library ${APP_DIR}/module/LinkedSwissbib/src/LinkedSwissbib --overwrite --output ${APP_DIR}/module/LinkedSwissbib/src/autoload_classmap.php
