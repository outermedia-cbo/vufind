...
$config = [
    ...
    'controllers' => [
        'invokables' => [
            ...
            'exploreauthor'  => 'LinkedSwissbib\Controller\ExploreAuthorController',
        ]
    ],
    'service_manager' => [
        'factories' => [
...
$staticRoutes = [
    'Exploration/Search', 'Elasticsearch/Results', 'Sparql/Results', 'Exploration/Author', 'Exploration/AuthorDetails', 'ExploreAuthor/Show'
    ];
